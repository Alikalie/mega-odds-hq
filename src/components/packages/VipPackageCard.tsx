  ...
  return (
    <>
      <motion.div
        ...
        className={`relative glass-card rounded-2xl p-6 border ${borderClass} ${isPopular ? glowClass : ""}`}
      >
        {isPopular && (
        ...
        <div className="text-center space-y-4">
          ...
          {user ? (
            ...
            <Button variant={tier === "vip" ? "vip" : "special"} size="lg" className="w-full" asChild>
